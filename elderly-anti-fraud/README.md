...
| 诈骗识别 | `pages/identify/` | 文字/图片识别、风险等级评估、应对建议、识别历史、**🔊 一键朗读**、**📷 拍照存证** |
...
| 家庭守护 | `pages/family/` | 角色选择（长辈/守护者）、6 位守护码、绑定/解除、守护动态、**📞 一键呼叫子女** |
| 个人中心 | `pages/profile/` | 识别历史、举报次数、大字模式、修改称呼、**关于本工具（合规说明）** |
| 关于页 | `pages/about/` | 产品定位、隐私摘要、免责声明、合规承诺（v1.1 新增） |
